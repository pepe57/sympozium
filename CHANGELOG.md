...
## [0.10.62](https://github.com/pepe57/sympozium/compare/v0.10.61...v0.10.62) (2026-09-12)


### Features

* accelerator power draw from a discovered energy collector ([e5aa1e4](https://github.com/pepe57/sympozium/commit/e5aa1e43369ef987839042d38b7c3b3e6cf87906))
* add envtest-based system tests for API server + controllers ([2344132](https://github.com/pepe57/sympozium/commit/2344132a7483162e66fb6f5deea341ff8e39d017))
* add explicit catalogue Harness selection to run APIs ([af20bac](https://github.com/pepe57/sympozium/commit/af20bac59080299ba51e7741153d7e3283ba0b6b))
* add llmfit DaemonSet for continuous cluster hardware fitness telemetry ([#186](https://github.com/pepe57/sympozium/issues/186)) ([ec896fa](https://github.com/pepe57/sympozium/commit/ec896fa37c5ba42f184e08e71e22224df9aaf59d))
* add named catalogue selection to Harness run APIs ([9a378ed](https://github.com/pepe57/sympozium/commit/9a378edb485dae6db514112a2cc17113f9ff3891))
* add persistent HarnessSession lifecycle ([#395](https://github.com/pepe57/sympozium/issues/395)) ([4019702](https://github.com/pepe57/sympozium/commit/40197029b8f6218ee74119faecb6b74deba9f0f3))
* Add skipped as AgentRun status - reachable via IPC similar to dry runs ([#228](https://github.com/pepe57/sympozium/issues/228)) ([056421c](https://github.com/pepe57/sympozium/commit/056421c6f1c7a0ad445ea3c2628da332103c12fa))
* add Stimulus node type for auto-triggered workflow prompts ([59fc3be](https://github.com/pepe57/sympozium/commit/59fc3be965733570e91da4e6aa2b3fb06ccf7fd3))
* add subagent ensemble examples to install defaults ([ddb8b0d](https://github.com/pepe57/sympozium/commit/ddb8b0d3f2eb525fd4bbf75b1690fcbffb41d7cf))
* add subagents skill for ad-hoc sub-agent spawning ([#171](https://github.com/pepe57/sympozium/issues/171)) ([2929a80](https://github.com/pepe57/sympozium/commit/2929a80ea9ccb79dde3cc8d8df03f03b4f105937))
* add Suspended field to MCPServer to prevent crash-looping defaults ([#195](https://github.com/pepe57/sympozium/issues/195)) ([6200f97](https://github.com/pepe57/sympozium/commit/6200f9737bbeef0487f0b3ca7e5bfb902d4b8fa3))
* add tolerations for agent pods ([#440](https://github.com/pepe57/sympozium/issues/440)) ([df23b2f](https://github.com/pepe57/sympozium/commit/df23b2fd9cc021c244ee22d17e48c29d3e9c7e68))
* agent edit redirect ([#320](https://github.com/pepe57/sympozium/issues/320)) ([c270aaf](https://github.com/pepe57/sympozium/commit/c270aafc4ce120e3f558a1d3f1c2ac1ccf700554))
* **agent-runner:** add opt-in detailed JSONL file logging with per-run directories ([#238](https://github.com/pepe57/sympozium/issues/238)) ([6d52537](https://github.com/pepe57/sympozium/commit/6d52537bcad973f0af37e0fa8afaceecaa910492))
* **agent-runner:** log LLM round progress during agent runs ([#225](https://github.com/pepe57/sympozium/issues/225)) ([c222b8e](https://github.com/pepe57/sympozium/commit/c222b8e664f42a69cad765b46e7e24a30f7df2a6))
* AgentRun dollar cost estimation with simulated pricing overlay ([798aa3f](https://github.com/pepe57/sympozium/commit/798aa3f36c1d211b94858931580e0768ba21b738))
* AgentRun dollar cost estimation with simulated pricing overlay ([dfe8fdf](https://github.com/pepe57/sympozium/commit/dfe8fdfcf4cac3418cca117eb4c8469a0c9550df))
* **apiserver:** reload SYMPOZIUM_UI_TOKEN from a mounted file ([#315](https://github.com/pepe57/sympozium/issues/315)) ([28cb1b7](https://github.com/pepe57/sympozium/commit/28cb1b7c52acfff50532a0aa002d46b302104681))
* auto-inject delegation/supervision context from ensemble relationships ([e38e93e](https://github.com/pepe57/sympozium/commit/e38e93ef6f930baf3149c4765a14644a1307154f))
* automatically issue registered catalogue compositions ([#459](https://github.com/pepe57/sympozium/issues/459)) ([d8b1c61](https://github.com/pepe57/sympozium/commit/d8b1c611f1ff8dbdbd288300122f9d886da01153))
* catalogue-derived requests and local host grant provisioning ([#443](https://github.com/pepe57/sympozium/issues/443)) ([7f60cb8](https://github.com/pepe57/sympozium/commit/7f60cb808f2534c5dd8ff5b34baa7971755fc87b))
* Celln hermetic-action backend for AgentRun ([da364c4](https://github.com/pepe57/sympozium/commit/da364c4c303f6b0a474934c2b322bbc99923fb87))
* Celln hermetic-action backend for AgentRun ([abea691](https://github.com/pepe57/sympozium/commit/abea6914b3d410409d7752a1b5ef877e662adf19))
* **celln:** add immutable tool catalogue and submission metadata ([2362880](https://github.com/pepe57/sympozium/commit/23628806a1c3aada7668daa69e59df1b86fdf213))
* **celln:** authenticate API capability discovery with read-only credentials ([34f7fe1](https://github.com/pepe57/sympozium/commit/34f7fe1f7a4d41754888aee6625943fa0e1772d9))
* **celln:** authenticated capability status and scoped discovery credentials ([0b1c927](https://github.com/pepe57/sympozium/commit/0b1c927420915d71950fada605365649cf71013e))
* **celln:** bind experimental in-cell Harness runs with frozen authority ([5515928](https://github.com/pepe57/sympozium/commit/55159281ea142dca8de2c5c12fcacc4683aeb87b))
* **celln:** build the host-installer image and centralize the Celln release pin ([f92c8b0](https://github.com/pepe57/sympozium/commit/f92c8b0214aa2be40e64268cc8a6022b0bbf01ae))
* **celln:** build the host-installer image and pin the Celln release ([28e3273](https://github.com/pepe57/sympozium/commit/28e3273503ba6c708aa3afb35757472a0e97f230))
* **celln:** declare runtime profiles with independent fail-closed readiness ([a8a01e6](https://github.com/pepe57/sympozium/commit/a8a01e63aed19a7fbf79f0a52b22829c8d7df7f1))
* **celln:** enable labelled KVM hosts by default ([#385](https://github.com/pepe57/sympozium/issues/385)) ([af3f0bb](https://github.com/pepe57/sympozium/commit/af3f0bb9284da54094a58cb0ca6de83fea730df9))
* **celln:** freeze experimental in-cell Harness bindings on AgentRun ([b331a29](https://github.com/pepe57/sympozium/commit/b331a2922235bf88491809e19a242a0035da3c4b))
* **celln:** immutable tool catalogue and unprivileged submissions ([865c4cd](https://github.com/pepe57/sympozium/commit/865c4cdbdd1f1b0f4e5a6814a8569e62e9f2c705))
* **celln:** native JSON Harness contracts and actual-controller proof ([027682d](https://github.com/pepe57/sympozium/commit/027682d552992c6538bd91c36f4dc4a27241439a))
* **celln:** native parent installation packaging and teardown safety ([#470](https://github.com/pepe57/sympozium/issues/470)) ([30fddf0](https://github.com/pepe57/sympozium/commit/30fddf0757710b2ca6c30befb1a28d8e88c66d71))
* **celln:** native persistent harness starter release candidate ([#463](https://github.com/pepe57/sympozium/issues/463)) ([0136e9a](https://github.com/pepe57/sympozium/commit/0136e9a3e159cc60facced820ccadd854581910f))
* **celln:** operator-reviewed catalogue publication ([f78761a](https://github.com/pepe57/sympozium/commit/f78761ad1e047008c088f47cce3b910dc98a32a4))
* **celln:** preview effective tool permissions without issuing authority ([#462](https://github.com/pepe57/sympozium/issues/462)) ([963c92d](https://github.com/pepe57/sympozium/commit/963c92dece1990fedc6e7d14d870ffeae1abc68c))
* **celln:** publish exact operator-reviewed catalogue revisions ([fdc2792](https://github.com/pepe57/sympozium/commit/fdc2792f549a96ef9e6801b097353e3d23ccb769))
* **celln:** resolve revision-bound tool authority intersections ([cea875f](https://github.com/pepe57/sympozium/commit/cea875fbf67f4fbd4df5ad4d2f818dea3a1734b1))
* **celln:** reusable ModelConnection routes for persistent harnesses ([dc8bb97](https://github.com/pepe57/sympozium/commit/dc8bb97477ad7214933cce38c0abd4705e3e8e3c))
* **celln:** revision-bound tool authority resolver ([25a2674](https://github.com/pepe57/sympozium/commit/25a2674855a541ae7696ce286eb752ad5b1d52a9))
* **celln:** runtime profile metadata and independent readiness ([0721533](https://github.com/pepe57/sympozium/commit/0721533c456b6224823d78686469738ab0f0b0d8))
* **celln:** single execution plane (unified client, chart, contract) ([#491](https://github.com/pepe57/sympozium/issues/491)) ([7a4d993](https://github.com/pepe57/sympozium/commit/7a4d993aca39769c11e79a1cc4376f63f2da4c62))
* **celln:** support native JSON Harness contracts and prove controller execution ([2dd256c](https://github.com/pepe57/sympozium/commit/2dd256cd20bf7cd822d5f108b493fc56febb4758))
* channel pod CSI compatibility and dedicated service account ([1aa9a99](https://github.com/pepe57/sympozium/commit/1aa9a992d6ca92ec2317c7d30dc2ea12ec27dafc))
* **channels:** wire per-agent display name for Slack sender attribution ([#263](https://github.com/pepe57/sympozium/issues/263)) ([1f52056](https://github.com/pepe57/sympozium/commit/1f5205692e7e79eca88ace59d2e4300f66e0b971))
* **cli:** add dashboard token command ([#388](https://github.com/pepe57/sympozium/issues/388)) ([fb8eeea](https://github.com/pepe57/sympozium/commit/fb8eeea41b7884d6e188478ca059e48de9530165))
* **collector+apiserver:** discover energy collectors, expose accelerator power ([a1bcbc2](https://github.com/pepe57/sympozium/commit/a1bcbc2949f631f527e9ce601b991d7ff9e70789))
* compact old tool results ([#316](https://github.com/pepe57/sympozium/issues/316)) ([460798d](https://github.com/pepe57/sympozium/commit/460798d947938293e7fbfc5ce493c9680bcef8d2))
* connect frozen catalogue issuance to controller execution lifecycle ([5fe2bab](https://github.com/pepe57/sympozium/commit/5fe2bab81001a00f88dcc9e3bda8127fbb8549f5))
* connect issued catalogue runs to controller recovery and dispatch ([811ba59](https://github.com/pepe57/sympozium/commit/811ba59bfc08c2d801c6e237c039c11ef289bcf1))
* **controller:** opt-in controller-side delegation executor ([#236](https://github.com/pepe57/sympozium/issues/236)) ([8e7dfd2](https://github.com/pepe57/sympozium/commit/8e7dfd2dd613dbb2b11d5ccdfcc311065c1f61c3))
* **controller:** opt-in controller-side delegation executor with guardrails + telemetry ([0179b44](https://github.com/pepe57/sympozium/commit/0179b4420465c44809f39fc1bb3e52c9c6334162))
* **crd:** gate ensemble auto-start with stimulus.trigger and schedule.firstTick ([b5ea9d3](https://github.com/pepe57/sympozium/commit/b5ea9d33cf614a4cd034c26e88e20653ca08c7cd))
* **cypress:** parameterize test model via CYPRESS_TEST_MODEL env var ([b4f68ea](https://github.com/pepe57/sympozium/commit/b4f68ea8dd5ba0ad6eef18476d5630d4d0c486dc))
* **cypress:** parameterize test model via CYPRESS_TEST_MODEL env var ([af6310b](https://github.com/pepe57/sympozium/commit/af6310b0f3ebfe6d361e75b6242bed6572546e53))
* deploy celln installer + router via Helm ([bda32eb](https://github.com/pepe57/sympozium/commit/bda32ebed47a35ab9df1ab3cc56b2e47f0084d2b))
* enable Celln backend by default in Helm chart ([e92e58a](https://github.com/pepe57/sympozium/commit/e92e58a14ca0f58554d2e4e9296a15858a0d287a))
* envtest-based system tests + Cypress fixes ([e173d95](https://github.com/pepe57/sympozium/commit/e173d95afc89f193ccab21eaed7ed2b638d10022))
* evidence traces for shared memory + memory browser UI ([#219](https://github.com/pepe57/sympozium/issues/219)) ([9ec7ccc](https://github.com/pepe57/sympozium/commit/9ec7ccc68b1480c3370934fecaf7a56a94b0292a))
* expand default MCP server catalog ([ab27fac](https://github.com/pepe57/sympozium/commit/ab27fac64b0b1ebdc6072de351c511439d8869a8))
* expand default MCP server catalog with grafana, kubernetes, argocd, and postgres ([b620dbf](https://github.com/pepe57/sympozium/commit/b620dbfb5aed5a2767bd4d50917e4f4a19ec897f))
* expose durable catalogue issuance through operator CLI ([c9c340e](https://github.com/pepe57/sympozium/commit/c9c340e728afcb3a3a64d8b6efd6b5b43a4b22fe))
* expose Harness in Celln catalogue selection in run UI ([fb4a694](https://github.com/pepe57/sympozium/commit/fb4a694cf74c3e06e99f33cf3206d4e5b7d1bbd2))
* freeze exact verified Celln issuance for dispatch hand-off ([#451](https://github.com/pepe57/sympozium/issues/451)) ([dd9abe1](https://github.com/pepe57/sympozium/commit/dd9abe137f44194bc698c1ea7919d333307ed34f))
* freeze serving route before Celln issuance ([#452](https://github.com/pepe57/sympozium/issues/452)) ([51b9454](https://github.com/pepe57/sympozium/commit/51b945432f27a1ed1d3f3d32094d684d81ba06c3))
* gate Celln behind explicit opt-in, add live status banner ([2d0c2ef](https://github.com/pepe57/sympozium/commit/2d0c2ef34b2b71de65c2261ba6764800b48bcca6))
* **harness:** add persistent Hermes default ([6f0a45b](https://github.com/pepe57/sympozium/commit/6f0a45ba02b8b300d06e60c3b044f20b30cc9940))
* **harness:** add the admin-owned AgentRuntime resource ([155c36f](https://github.com/pepe57/sympozium/commit/155c36f7b4b0fa5d0943defce4ef30f307ecc161))
* **harness:** add the admin-owned AgentRuntime resource ([c05fd7e](https://github.com/pepe57/sympozium/commit/c05fd7ec94a916a8a4132069c696bb77f71820ed))
* **harness:** close critical GA security gaps ([#414](https://github.com/pepe57/sympozium/issues/414)) ([e4a2f52](https://github.com/pepe57/sympozium/commit/e4a2f52adad4bc088dcd3add3537f708ef5549b2))
* **harness:** expose runtime selection in new run flow ([#369](https://github.com/pepe57/sympozium/issues/369)) ([2745414](https://github.com/pepe57/sympozium/commit/27454144c5f31350b6458fda3937d0069b196f4e))
* **harness:** inherit an Agent runtime across all run entrypoints ([480c719](https://github.com/pepe57/sympozium/commit/480c71976190aaaec0b86a4992c538b8d70ec1fa))
* **harness:** install maintained adapter catalog ([093d0ff](https://github.com/pepe57/sympozium/commit/093d0ff89f0a1f68f9970217a8c26519df7799ba))
* **harness:** install maintained adapter catalog ([ace6e60](https://github.com/pepe57/sympozium/commit/ace6e60c62f9fa11191c49235e87629a065702fd))
* **harness:** manage agent runtime from UI ([#376](https://github.com/pepe57/sympozium/issues/376)) ([5b9c67d](https://github.com/pepe57/sympozium/commit/5b9c67d4624bcfb2c88c6c876a6a9480b7129cbf))
* **harness:** reference an approved AgentRuntime from a run ([0e563f1](https://github.com/pepe57/sympozium/commit/0e563f156ad12877e5a8b97091bd3a199ab3df4c))
* **harness:** reference an approved AgentRuntime from a run ([9abf37d](https://github.com/pepe57/sympozium/commit/9abf37db01b48ae26547c3ac8a8f7dc73fe6fbd6))
* **harness:** select runtime while creating an agent ([#384](https://github.com/pepe57/sympozium/issues/384)) ([bb9baf7](https://github.com/pepe57/sympozium/commit/bb9baf7bd7960de5cc30de0c3b2b7166813eaf62))
* **harness:** show runtime provenance and reject unsupported settings ([#371](https://github.com/pepe57/sympozium/issues/371)) ([8c2e8e6](https://github.com/pepe57/sympozium/commit/8c2e8e6ff8007ef0b4dcc5222b3e2f459bb139fa))
* **harness:** track activity and enforce idle timeout ([f1de44c](https://github.com/pepe57/sympozium/commit/f1de44cc45a44ef309e8d8e600ffb0c03ca3b5c2))
* implement allow/deny tool policy semantics ([dfb12dd](https://github.com/pepe57/sympozium/commit/dfb12dde8175aede5c1a45b556dcaed649444854))
* independently resolve Celln model-policy approval ([#442](https://github.com/pepe57/sympozium/issues/442)) ([74d6673](https://github.com/pepe57/sympozium/commit/74d66736e7984ec20572e7cd451a034c1495f364))
* install Pi persistent session runtime by default ([#398](https://github.com/pepe57/sympozium/issues/398)) ([945ec14](https://github.com/pepe57/sympozium/commit/945ec149f9eff4d60abb5cf718843a931802ce80))
* **install:** deploy the Celln backend by default ([#483](https://github.com/pepe57/sympozium/issues/483)) ([dbf6f15](https://github.com/pepe57/sympozium/commit/dbf6f15aa83b40141efeb8a47a4882140c30cd51))
* journal local issuer authority and recover interrupted profiles ([#444](https://github.com/pepe57/sympozium/issues/444)) ([49a3e23](https://github.com/pepe57/sympozium/commit/49a3e2315df5291f07a2a5b55e84b56b9bb30e96))
* make harness execution a first-class Agent flow ([#391](https://github.com/pepe57/sympozium/issues/391)) ([2bb0fd7](https://github.com/pepe57/sympozium/commit/2bb0fd73e3e9ef43c6be7ff58b445335590256bd))
* make persistent harness chat agent-first ([#399](https://github.com/pepe57/sympozium/issues/399)) ([718ccf5](https://github.com/pepe57/sympozium/commit/718ccf59aa359cdc3a83c6467d8dec9de0abf9df))
* make persistent harness chat resumable ([#400](https://github.com/pepe57/sympozium/issues/400)) ([4a27062](https://github.com/pepe57/sympozium/commit/4a27062d846330be0d1f4a12c9a97f03ef58bbd2))
* manage local issuer startup recovery and periodic withdrawal ([#447](https://github.com/pepe57/sympozium/issues/447)) ([e2d9d6a](https://github.com/pepe57/sympozium/commit/e2d9d6a20f381d34160b1d551d250285ce070e10))
* migrate Celln dispatch to /v1/executions (forge mode) ([6b8b200](https://github.com/pepe57/sympozium/commit/6b8b200db97f7ee573fcc546f575aa876d84af82))
* native sidecar tools declared on SkillPack CRD ([#241](https://github.com/pepe57/sympozium/issues/241)) ([32a5acc](https://github.com/pepe57/sympozium/commit/32a5accb1dddc7ce4850b6a3c19952bb1c3ee392))
* offer Harness in Celln catalogue selection in the run UI ([fb9f443](https://github.com/pepe57/sympozium/commit/fb9f4439d5bf55fafce31318f01618a8ac920541))
* opt out for automatic memories ([8b74fa0](https://github.com/pepe57/sympozium/commit/8b74fa0ab9115b308d4d5fc63ca4fd6bb0467f30))
* Persist AgentRun.spec.Timeout and expose runTimeout via Ensemble config ([#230](https://github.com/pepe57/sympozium/issues/230)) ([897c5f0](https://github.com/pepe57/sympozium/commit/897c5f0a481e116374630e4feb040e97eb8e0379))
* persist bounded Celln issuance windows without retry renewal ([#446](https://github.com/pepe57/sympozium/issues/446)) ([44787c8](https://github.com/pepe57/sympozium/commit/44787c851c12efb2ee40da4bc96482e666c275e2))
* persist catalogue issuance through the operator CLI ([2588768](https://github.com/pepe57/sympozium/commit/2588768271a560dce131bafb332aa5f7cec3bdcd))
* persist frozen Celln issuance and resume verified outcomes ([#450](https://github.com/pepe57/sympozium/issues/450)) ([e690186](https://github.com/pepe57/sympozium/commit/e6901864c6789d948df6e0c4bf985bee0a0f6030))
* **placement:** claim-based model placement via bundled llmfit-dra ([07e2524](https://github.com/pepe57/sympozium/commit/07e252486a543f5670dfbc80c6be2a5de4105378))
* **placement:** claim-based model placement via bundled llmfit-dra ([21532a2](https://github.com/pepe57/sympozium/commit/21532a24b1bc2690a46343a6fd89027e542522c1))
* **placement:** claim-based model placement via bundled llmfit-dra ([4d70a1f](https://github.com/pepe57/sympozium/commit/4d70a1faf38a8933c03250a3e991a6275c0d66b2))
* **placement:** surface pending-pod scheduler verdicts; ensure claims on the deployment path ([d4e7132](https://github.com/pepe57/sympozium/commit/d4e7132f2957db27efddfd445221c794d274de8f))
* preserve frozen router execution identity through submission and recovery ([fb1aefd](https://github.com/pepe57/sympozium/commit/fb1aefd015bf6a1685f9558585e7e28a6041ec7c))
* reconcile issued Celln profiles against current approvals ([#445](https://github.com/pepe57/sympozium/issues/445)) ([3f660c3](https://github.com/pepe57/sympozium/commit/3f660c3e262da5681337b994152d05135e8d2cb3))
* register catalogue controller dispatch with explicit operator config ([da70fff](https://github.com/pepe57/sympozium/commit/da70fffa3dff5fb2b3e4e0886075b239ea52824e))
* router DaemonSet with downward API, zero IP config ([348cd3c](https://github.com/pepe57/sympozium/commit/348cd3caef9dbeb4122a68703bbaaa7ba06ba4b4))
* **security:** isolate Kubernetes identity per agent run ([f9229d4](https://github.com/pepe57/sympozium/commit/f9229d4b9ce85bc881822ef3010ec0b6672655c1))
* **security:** isolate Kubernetes identity per AgentRun ([5cd37a7](https://github.com/pepe57/sympozium/commit/5cd37a770df142fca52b6af3de7491829fcc2ec5))
* **security:** restrict harness NATS access ([925e6d9](https://github.com/pepe57/sympozium/commit/925e6d92ef5a1475d39dc2dd71a1047c53a73ad3))
* **security:** restrict harness NATS access ([c63a2e5](https://github.com/pepe57/sympozium/commit/c63a2e5a81e8a369068817d27641439bb8ed575d))
* serve managed Celln issuance over authenticated TLS ([#448](https://github.com/pepe57/sympozium/issues/448)) ([455cb4c](https://github.com/pepe57/sympozium/commit/455cb4c92a9dc3a788416fbafce4cc1b811a84b1))
* **serve:** auto-login web UI via token in the URL fragment ([5aa40ba](https://github.com/pepe57/sympozium/commit/5aa40ba8233c826f44fa9e7b8a7f102b35d51433))
* **serve:** URL auto-login; standalone agent topology nodes ([f19d0be](https://github.com/pepe57/sympozium/commit/f19d0bed5e25738a1eca6994ac338114e4961d42))
* **sessionkey:** stable per-conversation session keys ([#408](https://github.com/pepe57/sympozium/issues/408)) ([13ce3a3](https://github.com/pepe57/sympozium/commit/13ce3a3bab2f3ace6f9ade6151f46cf29b4353d7))
* shared stimulus view/edit/retrigger dialog across all canvases ([#165](https://github.com/pepe57/sympozium/issues/165)) ([196f219](https://github.com/pepe57/sympozium/commit/196f219b90632b201e8d4fb765ceeb7872a65c9b))
* **sidecar-driven:** polymorphic task + TaskModeHandler registry ([#302](https://github.com/pepe57/sympozium/issues/302)) ([c3038ea](https://github.com/pepe57/sympozium/commit/c3038ea4065a02763059ac55c794e45e858ab9c1))
* **slack:** per-message sender attribution for multi-agent Ensembles ([#245](https://github.com/pepe57/sympozium/issues/245)) ([5239b4d](https://github.com/pepe57/sympozium/commit/5239b4d9945ee788ad16e01fe0c49866a73e74d8))
* sort all API list endpoints and add prompt engineering guide ([52e643e](https://github.com/pepe57/sympozium/commit/52e643edcaed57d69185706fc6f4073955a5ed0a))
* stimulus node support in builder, unified canvas primitives, and UX fixes ([#162](https://github.com/pepe57/sympozium/issues/162)) ([a57c8f1](https://github.com/pepe57/sympozium/commit/a57c8f1c1ff7d41dcde2bb34ae0c84bf5ce79473))
* stimulus trigger gating, workstation topology demo, and buildable demo hardware ([4d39487](https://github.com/pepe57/sympozium/commit/4d394873a4132fba73416ce83c5dba9805ed7e46))
* stream persistent harness chat responses ([#403](https://github.com/pepe57/sympozium/issues/403)) ([5a4c832](https://github.com/pepe57/sympozium/commit/5a4c8322e5954c47f452ebfb6bca1aef23cab7a2))
* subagents skill for ad-hoc sub-agent spawning ([#175](https://github.com/pepe57/sympozium/issues/175)) ([3b6e354](https://github.com/pepe57/sympozium/commit/3b6e3549739079baf4d184594bb6201a88f4fd07))
* support custom headers for model provider requests ([#210](https://github.com/pepe57/sympozium/issues/210)) ([8412662](https://github.com/pepe57/sympozium/commit/8412662a1076b5d5a71e3626a69ab32bd95f8037))
* ToolPolicy allow/deny propagation and runner-side filtering ([ebcdafe](https://github.com/pepe57/sympozium/commit/ebcdafef29e18c60f60e6feade0e641eecaffbe4))
* topology dagre layout, synthetic membrane page, and UX improvements ([4cef6a2](https://github.com/pepe57/sympozium/commit/4cef6a27b4cf6c01ffd89d7a9659243cf12bc94b))
* topology keyboard navigation and demo gif ([2d8b417](https://github.com/pepe57/sympozium/commit/2d8b4176677ee0967ba85f527386d361cff89a02))
* trusted Celln catalogue planning and operator composition ([#441](https://github.com/pepe57/sympozium/issues/441)) ([1edd036](https://github.com/pepe57/sympozium/commit/1edd03680308202eb5e676f715498cc9d7b1f332))
* **tui:** add search/filter, log improvements, status colors, and run table enhancements ([#209](https://github.com/pepe57/sympozium/issues/209)) ([d70da82](https://github.com/pepe57/sympozium/commit/d70da82a6c32d5acfcda666df731723f234d613d))
* **tui:** update TUI colors to neo-industrial palette ([8402a5e](https://github.com/pepe57/sympozium/commit/8402a5e61f4e5e66ccb7e0e1fa995aae54100ad6))
* update TUI, topology, and ensemble canvas to industrial palette ([f7a3bc7](https://github.com/pepe57/sympozium/commit/f7a3bc721d95e57728367f056c29c8f6e5b20d3e))
* verify pinned router prewarm with real KVM proof ([#453](https://github.com/pepe57/sympozium/issues/453)) ([6bc9246](https://github.com/pepe57/sympozium/commit/6bc9246e39c3c7b61483cdaa0497abd52272a404))
* verify remote Celln issuance with a bounded TLS client ([#449](https://github.com/pepe57/sympozium/issues/449)) ([cc3de76](https://github.com/pepe57/sympozium/commit/cc3de7688a9b37724d863456d2fed7c8a82c405a))
* **web+apiserver:** decorate topology nodes with llmfit-dra accelerator inventory ([4bcaeef](https://github.com/pepe57/sympozium/commit/4bcaeef1fe1912f6c988153fb6cdb69739cef544))
* **web:** accelerator tree leaves on density nodes and topology cards ([2bebd1a](https://github.com/pepe57/sympozium/commit/2bebd1aec653c18a82c01eccac01d3ec38f93734))
* **web:** add approved harness registry ([9eedf0c](https://github.com/pepe57/sympozium/commit/9eedf0c855136c2ff0df79720a3bec2cc08f096d))
* **web:** add harness trust detail view ([43d7625](https://github.com/pepe57/sympozium/commit/43d762507a9c15102bb00bb8fec482a4da008cc4))
* **web:** Celln insecure model routes and native conversation UX ([#482](https://github.com/pepe57/sympozium/issues/482)) ([b79a7ca](https://github.com/pepe57/sympozium/commit/b79a7ca4d44b544a985990f89979cfe67cdac312))
* **web:** draw demo topology nodes as workstations with accelerator bays ([129cdba](https://github.com/pepe57/sympozium/commit/129cdbab774aa0423e639634a66dff40177029d0))
* **web:** let the ensemble builder choose the stimulus trigger mode ([bc5a8cb](https://github.com/pepe57/sympozium/commit/bc5a8cbabb57b32570cd9822a4d1d60ed1012cc4))
* **web:** live accelerator power on density and topology node views ([52c77a6](https://github.com/pepe57/sympozium/commit/52c77a6e70a79ee3300835b524c812c0741e7030))
* **web:** neo-industrial UX theme with classic toggle ([#200](https://github.com/pepe57/sympozium/issues/200)) ([5af0144](https://github.com/pepe57/sympozium/commit/5af0144a5543523c21f6d12d4b3941d7cd53b595))
* **web:** organize agent detail around harness and ensemble ([a6b4c64](https://github.com/pepe57/sympozium/commit/a6b4c641793955b105e75ac87b5875d534e6fba7))
* **web:** render standalone agents on the topology with model edges ([ba22b3e](https://github.com/pepe57/sympozium/commit/ba22b3e82f48bdaf9295ad3cb7d839bdb5ab773a))
* **web:** show estimated spend inline in the conversation panel ([87f4435](https://github.com/pepe57/sympozium/commit/87f443574100c82c7be090a195bac5c4df1c0fca))
* **web:** simulated accelerator power in the topology demo ([409eceb](https://github.com/pepe57/sympozium/commit/409eceb26961988a3484aab661196f05057433e8))
* **web:** single effective spend value with totals per page and conversation ([46e6537](https://github.com/pepe57/sympozium/commit/46e6537f105f3edb0c628849fd4418c46a1b549d))
* **web:** split feed into one-shot runs and persistent sessions ([#411](https://github.com/pepe57/sympozium/issues/411)) ([8a09d1b](https://github.com/pepe57/sympozium/commit/8a09d1b64c25882dc84994a7a6660f002ed08421))
* **web:** surface interactive sessions at top of Harnesses page ([#413](https://github.com/pepe57/sympozium/issues/413)) ([5a53be6](https://github.com/pepe57/sympozium/commit/5a53be6f046e7fca2780f3bc2230ee2d19588c67))
* **web:** unify the Run/Harness × Kubernetes/Celln creation matrix ([#492](https://github.com/pepe57/sympozium/issues/492)) ([1ff3e47](https://github.com/pepe57/sympozium/commit/1ff3e471f801c815b33b43b04ec50ca66d3fad03))
* **web:** waiting reasons on topology model nodes; consolidate Models nav ([8813105](https://github.com/pepe57/sympozium/commit/881310578d8b68f2a86d1f3303b35d08e83bc0a6))
* **web:** waiting reasons on topology model nodes; consolidate Models nav ([ad5e566](https://github.com/pepe57/sympozium/commit/ad5e5664b65657cc981be1f34f5bfa383230d4c9))
* wire ToolPolicy.Deny to agent-runner tool filtering (VEL-1084) ([6bd88e4](https://github.com/pepe57/sympozium/commit/6bd88e4ca082e725fcd9afe78f8da4241767850e))
* **workspace:** per-session persistent workspaces via WorkspaceSession CRD ([#409](https://github.com/pepe57/sympozium/issues/409)) ([30c8ead](https://github.com/pepe57/sympozium/commit/30c8ead556bfd86792be198b03d0167dd9faa425))


### Bug Fixes

* 468: Propagate traceparent on LLM provider calls ([#469](https://github.com/pepe57/sympozium/issues/469)) ([5c906bd](https://github.com/pepe57/sympozium/commit/5c906bddfeb8f42bf2c158689a57b221ec017822))
* add build tag to system tests so go test ./... skips them ([50052f0](https://github.com/pepe57/sympozium/commit/50052f0d10ea250ec7e4984b28db97b98a00347c))
* add watch verb to apiserver secrets RBAC ([3037f65](https://github.com/pepe57/sympozium/commit/3037f65768d6b03b22ff5e1329e8ebe45e902aca))
* **agent-runner:** serialize Bedrock tool schemas as JSON objects ([#259](https://github.com/pepe57/sympozium/issues/259)) ([f0f22c7](https://github.com/pepe57/sympozium/commit/f0f22c78a0c64e8dacc38714354632a15e8cf907)), closes [#255](https://github.com/pepe57/sympozium/issues/255)
* align Ensemble update path with create path for all Agent fields ([#264](https://github.com/pepe57/sympozium/issues/264)) ([e33be9f](https://github.com/pepe57/sympozium/commit/e33be9f1a51e6f92410d06ecbbdf99e900b0f2bd))
* allow unauthenticated custom providers in wizard ([db1036d](https://github.com/pepe57/sympozium/commit/db1036dcbf2895f737c043d94a4e4017341363b5))
* allow unauthenticated custom providers in wizard ([bccce53](https://github.com/pepe57/sympozium/commit/bccce53e8a1882585d8c674ad0d72d16de023fc6))
* **api:** retain harness prompt for runtime runs ([#373](https://github.com/pepe57/sympozium/issues/373)) ([efe766e](https://github.com/pepe57/sympozium/commit/efe766e9e6ec6cbdb66a20c61cbfb65311fcc9ed))
* **apiserver:** bound optional NATS initialization and honor UI disable ([b525711](https://github.com/pepe57/sympozium/commit/b5257115cf4affb728df43399e37d54f4a9a3789))
* **apiserver:** bound optional NATS startup and honor disabled UI ([3d16c84](https://github.com/pepe57/sympozium/commit/3d16c8475ae09d924f62b9b7dda597f1bac9ca8d))
* canary first run never triggers after duplicate-prevention change ([0bbf126](https://github.com/pepe57/sympozium/commit/0bbf12614d18fb260acb498514d204f34b0f1126))
* canary first run never triggers after duplicate-prevention change ([2e1caeb](https://github.com/pepe57/sympozium/commit/2e1caeb2e0fbdf33b07463f059a5e6f90ec2a2ac))
* **celln:** Agent execution defaults and accurate availability messaging ([#478](https://github.com/pepe57/sympozium/issues/478)) ([eeee90a](https://github.com/pepe57/sympozium/commit/eeee90acf7ae0478ed3fcfdd5461ad26a1353f54))
* **celln:** host installer and in-cluster dispatcher are mutually exclusive ([#487](https://github.com/pepe57/sympozium/issues/487)) ([43ad9a2](https://github.com/pepe57/sympozium/commit/43ad9a2228555348a5f05c224f1d82fc064f1580))
* **celln:** remove unused celln-dispatcher-token Secret ([183b8a5](https://github.com/pepe57/sympozium/commit/183b8a52b97d507ad48fc93e61a62cef7646c322))
* **celln:** restrict router ingress to control-plane controller ([9c3fd52](https://github.com/pepe57/sympozium/commit/9c3fd5273a0464850a621c26a23a44a5e47e82fc))
* **celln:** restrict router ingress to controller namespace and pods (M0) ([0953b01](https://github.com/pepe57/sympozium/commit/0953b017c6538a0fae2dc15b9c2d66f45c8fbd16))
* **celln:** use Recreate strategy for the in-cluster dispatcher ([#488](https://github.com/pepe57/sympozium/issues/488)) ([2bcc10e](https://github.com/pepe57/sympozium/commit/2bcc10ecd85dc120cec7c833ced28bc4d6385bb0))
* **celln:** wire durable router deployment with explicit trust configuration ([d845fa1](https://github.com/pepe57/sympozium/commit/d845fa1f94ac32318b0de6c863e72814701d5fa4))
* **celln:** wire replicated routers with durable ownership and explicit credentials ([fe09549](https://github.com/pepe57/sympozium/commit/fe09549cc3a8e9d6a3caf85d180749dbf417287a))
* channelTriggers propagation from Ensembles ([#191](https://github.com/pepe57/sympozium/issues/191)) ([9192ae9](https://github.com/pepe57/sympozium/commit/9192ae914aa8f3c3b0a211c338b107f546b79c56))
* **ci:** add llmfit-daemon to build and release image matrices ([df3f7e1](https://github.com/pepe57/sympozium/commit/df3f7e10c313680b5d9a3b28d8b4edd398edbdda))
* **ci:** allow explicit image fleet rebuilds ([567564a](https://github.com/pepe57/sympozium/commit/567564ac044054836d682e12dabaadf741f2b404))
* **ci:** disable fail-fast on release image matrix ([50661f8](https://github.com/pepe57/sympozium/commit/50661f8a3a07b8a71e5591821e66acd5f7ab6723))
* **ci:** evaluate manual build after skipped detection ([39efce6](https://github.com/pepe57/sympozium/commit/39efce655138a1e1d16f047de20a5eac25977cf6))
* **ci:** preserve required image builds ([9da627d](https://github.com/pepe57/sympozium/commit/9da627d280a7bf06fe485f8368dfae0692ecfb4f))
* clear stale baseURL when switching to a cloud provider ([6345d1f](https://github.com/pepe57/sympozium/commit/6345d1fe21efac18806c1e84ca70b6f47fb2da62))
* **controller:** gate the amd64-only Celln CLI in the multi-arch image ([#493](https://github.com/pepe57/sympozium/issues/493)) ([94dd83a](https://github.com/pepe57/sympozium/commit/94dd83ab3b13434871183ef873885cf78305bdb6))
* **controller:** honor SYMPOZIUM_IMAGE_TAG for run pods + memory sidecar (ISI-1406/ISI-1417) ([#244](https://github.com/pepe57/sympozium/issues/244)) ([604dd57](https://github.com/pepe57/sympozium/commit/604dd57dc46c43dd4ec1449dcd670b84d37feaed))
* **controller:** make sequential handoff truncation legible ([bae9701](https://github.com/pepe57/sympozium/commit/bae9701bf97cdb55471fdf4706cf73b4def31854))
* **controller:** propagate runTimeout and wire agentEnv into pod spec ([#240](https://github.com/pepe57/sympozium/issues/240)) ([d9f584e](https://github.com/pepe57/sympozium/commit/d9f584e61f611084fd527389434eb875ab41c70c))
* **controller:** propagate sidecar tools from source SkillPack ([#250](https://github.com/pepe57/sympozium/issues/250)) ([46b2cdc](https://github.com/pepe57/sympozium/commit/46b2cdcade676d9751eae4391d36603b7018ee69))
* **controller:** reject forged token metrics from agent result markers ([8227556](https://github.com/pepe57/sympozium/commit/8227556c3616030c4d25740fb730ef4822d12180))
* **controller:** remove unused triggered var breaking PR [#256](https://github.com/pepe57/sympozium/issues/256) build (ISI-1562) ([77ecdb7](https://github.com/pepe57/sympozium/commit/77ecdb7e7b5b2c284c62a05d4f44e3f970a7458f))
* **controller:** replace LastRunName check with List to prevent TOCTOU race ([#239](https://github.com/pepe57/sympozium/issues/239)) ([a419afe](https://github.com/pepe57/sympozium/commit/a419afe7fa898468ba4f11e2033bf7fb32d97a78))
* **controller:** requeue delegation successor when at in-flight cap (PR [#256](https://github.com/pepe57/sympozium/issues/256)) ([3aafd0f](https://github.com/pepe57/sympozium/commit/3aafd0f56df62990f7c300b7af29e2a5326981e4))
* **controller:** resolve PR [#256](https://github.com/pepe57/sympozium/issues/256) maintainer review findings ([7746942](https://github.com/pepe57/sympozium/commit/7746942f1a7dc4a208164ef2cba9ec821c31936f))
* correct CHANGELOG header to match actual version 0.10.27 ([3e5ee70](https://github.com/pepe57/sympozium/commit/3e5ee70a943459beaf7d81514b068926921fd9b0))
* correct MCP server configs after local testing ([6d56e57](https://github.com/pepe57/sympozium/commit/6d56e57d17d23cc5db1505cd90299ed1409f2a84))
* **crd:** accept both string-form and object-form spec.task at admission ([#312](https://github.com/pepe57/sympozium/issues/312)) ([a29016c](https://github.com/pepe57/sympozium/commit/a29016c2d833ac23cc54da33a4e205d32fc3cd77))
* default MCP server catalog to disabled (opt-in) ([d164dc0](https://github.com/pepe57/sympozium/commit/d164dc01fa7488daf8beac7c7f31d43a839ca5fc))
* derive Celln action IDs from AgentRun name+UID, not name alone ([7d8f85c](https://github.com/pepe57/sympozium/commit/7d8f85cf8c2326d431491f0ba684087907e597bc))
* don't hijack canvas zoom/pan keys while typing in inputs ([#221](https://github.com/pepe57/sympozium/issues/221)) ([39940e0](https://github.com/pepe57/sympozium/commit/39940e0f076794076cb22b9bfad7549c2381e912))
* enforce a controller-side deadline for wedged Celln backends ([d4f46d7](https://github.com/pepe57/sympozium/commit/d4f46d7c2cba31e30e265a49b2f64a4073835363))
* enforce sequential ordering in pipeline ensembles ([a86bcc6](https://github.com/pepe57/sympozium/commit/a86bcc60b78ae9cedab266b4ed370834786610cd))
* **eventbus:** bound core NATS publish flushes ([#365](https://github.com/pepe57/sympozium/issues/365)) ([2c90d1b](https://github.com/pepe57/sympozium/commit/2c90d1bee58f366e5f341c7c5a374993de3c3373))
* **eventbus:** recover NATS subscriptions after restart/recreate ([#253](https://github.com/pepe57/sympozium/issues/253)) ([#254](https://github.com/pepe57/sympozium/issues/254)) ([f341b37](https://github.com/pepe57/sympozium/commit/f341b372f5a3c1ef69b30a4a7555b048f643e52e))
* **examples:** give the research demo a brief that actually directs research ([de77fda](https://github.com/pepe57/sympozium/commit/de77fdad7e00c05b68326831115894185e8cd0ad))
* guard against unreachable cron expressions in schedule controller ([#220](https://github.com/pepe57/sympozium/issues/220)) ([a776f4d](https://github.com/pepe57/sympozium/commit/a776f4daa01d380092447cee2a26cb65416f3395))
* **harness:** allow default use context setting ([#374](https://github.com/pepe57/sympozium/issues/374)) ([4b6733f](https://github.com/pepe57/sympozium/commit/4b6733f89d15a4c85287bfc02b6c0df8f74fcf94))
* **harness:** auto-start persistent agent sessions ([4f8c538](https://github.com/pepe57/sympozium/commit/4f8c5382756d110b13ef2ad8850bc6825d63853a))
* **harness:** harden persistent session lifecycle ([#417](https://github.com/pepe57/sympozium/issues/417)) ([73d24f2](https://github.com/pepe57/sympozium/commit/73d24f2cfa9d7c11e1fdfc6e1d69d1d7d469566e))
* **harness:** inherit agent runtimes on normal runs ([058ec37](https://github.com/pepe57/sympozium/commit/058ec3793dd99b59e655b2c5de0d5295116bc642))
* **harness:** persist session state across restarts ([#407](https://github.com/pepe57/sympozium/issues/407)) ([c3bab88](https://github.com/pepe57/sympozium/commit/c3bab88a267a798b682f2e7b7ca3ad338378b0e8))
* **harness:** pin corrected Hermes session image ([1d281a4](https://github.com/pepe57/sympozium/commit/1d281a468ad6561206a23b0390e385ffa856868a))
* **harness:** preserve inherited runtime provenance ([#380](https://github.com/pepe57/sympozium/issues/380)) ([f79f2f1](https://github.com/pepe57/sympozium/commit/f79f2f15ffbce465c21131881ad18f1a67e386b1))
* **harness:** probe loopback skill tool server in-container ([#381](https://github.com/pepe57/sympozium/issues/381)) ([e87ae07](https://github.com/pepe57/sympozium/commit/e87ae07549c52b9de157f676fd84912dc7592f3e))
* **harness:** require digest-pinned adapter images ([8636cf9](https://github.com/pepe57/sympozium/commit/8636cf9efb5ccd4fc0ca994ef5ba7b5cbb4e3f8a))
* **harness:** require digest-pinned adapter images and record the digest ([9a9ce81](https://github.com/pepe57/sympozium/commit/9a9ce8112ead856a3050e1272a435cab21395fb1))
* **harness:** require explicit policy opt-in ([1326b1f](https://github.com/pepe57/sympozium/commit/1326b1f7a9bbdf177dc7225c0a3f6da2eb110737))
* **harness:** restrict model credentials to agent allowlist ([44ef22a](https://github.com/pepe57/sympozium/commit/44ef22a5fbe0c38631a86d304047969ad35b2f43))
* **harness:** restrict model credentials to Agent allowlist ([a8d9ff5](https://github.com/pepe57/sympozium/commit/a8d9ff52ca631e56641d8c169db7fcf55750b129))
* **harness:** retain idle timeout condition ([8cd7eb8](https://github.com/pepe57/sympozium/commit/8cd7eb83aebe5fd54dbcb30c478e410b11b19c0c))
* **harness:** separate persistent sessions from one-shot runs ([#404](https://github.com/pepe57/sympozium/issues/404)) ([776dcc4](https://github.com/pepe57/sympozium/commit/776dcc4c90b004389c0efbad71826582612d3e7f))
* **helm:** suspend postgres MCP server by default ([#420](https://github.com/pepe57/sympozium/issues/420)) ([6ec7da6](https://github.com/pepe57/sympozium/commit/6ec7da6742b52e639635b5371e94cf57d1f9e970))
* **install:** make uninstall aware of the bundled llmfit-dra subchart ([92cbef8](https://github.com/pepe57/sympozium/commit/92cbef80be3d581db2ac9f20e3f14fec7f72da0d))
* **install:** make uninstall aware of the bundled llmfit-dra subchart ([576b7b6](https://github.com/pepe57/sympozium/commit/576b7b6a17839672c51a2044759c4328c9c8ec89))
* **install:** vendor the bundled llmfit-dra chart for the embedded installer ([def0522](https://github.com/pepe57/sympozium/commit/def0522e3910b7115b319afd328f5a40a67414a1))
* **ipc:** reconcile pre-existing result files on watch registration ([6e08fd9](https://github.com/pepe57/sympozium/commit/6e08fd92a1d34d01fc95c69d8e098040a7d28390))
* make subagent fanout limits and names reliable ([#247](https://github.com/pepe57/sympozium/issues/247)) ([f156807](https://github.com/pepe57/sympozium/commit/f15680767c6c403d4f51a924db7bf2e78f4bcc51))
* manually construct Azure OpenAI deployment URL ([58dbcb1](https://github.com/pepe57/sympozium/commit/58dbcb1faf83a5e8d978e975013900a441608893))
* manually construct Azure OpenAI deployment URL to work around SDK middleware bug ([ac9cdb5](https://github.com/pepe57/sympozium/commit/ac9cdb53ad7276d6631dc68d6ba1782e3d12f129))
* mcp-bridge missing notifications/initialized and sequential discovery ([#197](https://github.com/pepe57/sympozium/issues/197)) ([6e5d4a1](https://github.com/pepe57/sympozium/commit/6e5d4a16c5cac5022952a7f22f551bfa7e32f8ec)), closes [#194](https://github.com/pepe57/sympozium/issues/194)
* **memory:** reconcile managed server image ([ee1c92f](https://github.com/pepe57/sympozium/commit/ee1c92f39034b35b48d90100345a2cc3656717f8))
* **memory:** reconcile managed server image ([00c3ac7](https://github.com/pepe57/sympozium/commit/00c3ac72b589c9e950230f99943db2ace4be0344))
* **nats:** authenticate density subscriber ([9b0c6fa](https://github.com/pepe57/sympozium/commit/9b0c6fab41b69827268df3454a673f9b3575995c))
* pass baseURL as wizard default when re-enabling ensemble ([3e8b98d](https://github.com/pepe57/sympozium/commit/3e8b98defff3d90801955ebda4707e3bbbcc363b))
* preserve ensemble auth config on disable and clean up stale runs ([00ac9e4](https://github.com/pepe57/sympozium/commit/00ac9e468bbb15d2f20140337d4b91436e177352))
* preserve namespace for subagent spawning ([#234](https://github.com/pepe57/sympozium/issues/234)) ([5c7bd03](https://github.com/pepe57/sympozium/commit/5c7bd03bad449bd79f5ca3c412a040f7d333f89d))
* prevent duplicate canary runs on first schedule trigger ([1f5e286](https://github.com/pepe57/sympozium/commit/1f5e2864ecc5bd421ddfc0fa73f0533e963c7f55))
* prevent duplicate canary runs on first schedule trigger ([1428d68](https://github.com/pepe57/sympozium/commit/1428d68df148a004e60e9e7e47d11902a094fea6))
* prevent panic when AgentRun has nil Labels map ([#170](https://github.com/pepe57/sympozium/issues/170)) ([6f0792f](https://github.com/pepe57/sympozium/commit/6f0792ff7da72faf76b5f9012337c2d9f35b375c))
* prevent port-forward reconnect loop when port is already bound ([c39199e](https://github.com/pepe57/sympozium/commit/c39199eb4d07541f61c88ea018fa50b990b6234e))
* propagate Ensemble toolPolicy to AgentRun pods ([67b9161](https://github.com/pepe57/sympozium/commit/67b9161e032c409534ade952a6ae05119afacd9a))
* propagate Memory.SystemPrompt to AgentRuns ([#169](https://github.com/pepe57/sympozium/issues/169)) ([bc20d3d](https://github.com/pepe57/sympozium/commit/bc20d3dbe78ef560218140987c1043f89750ceec))
* propagate skill changes to existing Agents on ensemble update ([2a498c7](https://github.com/pepe57/sympozium/commit/2a498c733bf10b5494572e850410b7c1339983b7))
* provider-agnostic API key secret (openaiApiKey, anthropicApiKey, deepseekApiKey) ([1321032](https://github.com/pepe57/sympozium/commit/1321032c1f546c487aba14f2ca08ae2f56f10004))
* **rbac:** grant controller and apiserver access to agentruntimes ([94ed965](https://github.com/pepe57/sympozium/commit/94ed965a738b735e3a4851ead6db19225f056e0e))
* recover from stuck Terminating namespace during install ([#173](https://github.com/pepe57/sympozium/issues/173)) ([30d59a8](https://github.com/pepe57/sympozium/commit/30d59a8b9976a542b7cc0e60bf97413f8345d51a))
* reject AgentRuns with both backend=celln and agentSandbox.enabled ([2de81c8](https://github.com/pepe57/sympozium/commit/2de81c841eed5a91020cfac9daaf2c5406b81f13))
* **release:** enable Homebrew tap updates ([5aaf821](https://github.com/pepe57/sympozium/commit/5aaf821ffdbb5ee3935f2796d2811916e73746e7))
* **release:** enable Homebrew tap updates ([e0a3512](https://github.com/pepe57/sympozium/commit/e0a35126c6a52e399fae64b57afa8f5b73d6d0b4))
* remove finish_reason gate for tool call extraction ([#227](https://github.com/pepe57/sympozium/issues/227)) ([14cea32](https://github.com/pepe57/sympozium/commit/14cea3235950088450d506d547b741e6f1b9d865))
* replace remaining gradient buttons with theme-aware primary and update README demo image ([#203](https://github.com/pepe57/sympozium/issues/203)) ([e85c1cf](https://github.com/pepe57/sympozium/commit/e85c1cf95747360692650d3b6006d69575e1066b))
* resolve flaky Cypress tests for run-delete and run-notifications ([74bab5a](https://github.com/pepe57/sympozium/commit/74bab5a59cca869862facb1bd9e62edb9fbbcc71))
* restore version to 0.10.26 after release-please confusion ([aa1ec8b](https://github.com/pepe57/sympozium/commit/aa1ec8b24efac88cc7a3cca7455fcdab929b01cc))
* restore version to 0.10.27 after release-please revert ([ee01f90](https://github.com/pepe57/sympozium/commit/ee01f90d24a94acf6357821dba56e86af45ce96f))
* restrict WhatsApp channel to self-chat messages only ([3425eb8](https://github.com/pepe57/sympozium/commit/3425eb80290f95ce229e91850caef1f1db4e8e6b))
* restrict WhatsApp channel to self-chat messages only ([6af4dca](https://github.com/pepe57/sympozium/commit/6af4dcaad6f9e2372e917c4f95e3dd952c706c3e)), closes [#138](https://github.com/pepe57/sympozium/issues/138)
* retry Celln router-unreachable errors on a fixed 10s cadence ([eff0d03](https://github.com/pepe57/sympozium/commit/eff0d03e0489ec71310750a04d2429e256d76e12))
* router port 8788 (dispatcher uses 8787), TCP probes ([8165c72](https://github.com/pepe57/sympozium/commit/8165c7246cb38eb660cf85491718eeb086e0d3b1))
* scope TUI resource lists to the active namespace ([#217](https://github.com/pepe57/sympozium/issues/217)) ([6479fe5](https://github.com/pepe57/sympozium/commit/6479fe5f27714f82da20ced42de6218b21018c4a)), closes [#215](https://github.com/pepe57/sympozium/issues/215)
* **security:** tier-1 hardening for delegation, channels, and API auth ([#265](https://github.com/pepe57/sympozium/issues/265)) ([6fd740d](https://github.com/pepe57/sympozium/commit/6fd740db84db9a37baffb3dd607fb48b2035e713))
* sort runs list by creation date descending (fixes [#151](https://github.com/pepe57/sympozium/issues/151)) ([bed055c](https://github.com/pepe57/sympozium/commit/bed055c97af6abdff50edb8e93e2bf14bd164fca))
* stimulus save, canvas sync, agentrun cleanup, and default MCP servers ([ad6752f](https://github.com/pepe57/sympozium/commit/ad6752fa3bad572062aa6c88269f2bb761c5a203))
* support keyless local harness inference ([#406](https://github.com/pepe57/sympozium/issues/406)) ([f61e861](https://github.com/pepe57/sympozium/commit/f61e861c6a07712d44cf8465968f89b4ba4a5a53))
* update cypress tests for stimulus relationship in research-team pack ([e21dff9](https://github.com/pepe57/sympozium/commit/e21dff97b4a6db335e56dec7db1dd787f8822ef4))
* update TUI terminology from Personas/Instances to Ensembles/Agents ([#182](https://github.com/pepe57/sympozium/issues/182)) ([7e48fe5](https://github.com/pepe57/sympozium/commit/7e48fe578083190c62999b93f4e107c0adf0a334))
* use correct installedPersonas field in ensemble detail page ([b62eea4](https://github.com/pepe57/sympozium/commit/b62eea46f38e92d2d052b0a3b3afa7b1d7a0af71))
* **web-proxy:** close subscribe-before-find race and skip terminal runs ([71786b7](https://github.com/pepe57/sympozium/commit/71786b736dc6ec8ef93c0ecaf31d04f5a2771a45))
* **web-proxy:** close subscribe-before-find race and skip terminal runs ([77c1267](https://github.com/pepe57/sympozium/commit/77c12673dad1d21d063418a527c88ae1c85018b7))
* **web-proxy:** dedupe retried chat requests ([bec7af2](https://github.com/pepe57/sympozium/commit/bec7af286bd761016659c838af7d1819172bc48b))
* **web-proxy:** dedupe retried chat requests ([d4233f3](https://github.com/pepe57/sympozium/commit/d4233f3f4fc7c8153e1b7f2d9737d36c7340b988))
* **web:** clarify Celln selection and topology ordering ([#473](https://github.com/pepe57/sympozium/issues/473)) ([3c19e60](https://github.com/pepe57/sympozium/commit/3c19e6032ac583b898fa01187299cce990a0e92c))
* **web:** clarify execution plane vs runtime ([c7f3048](https://github.com/pepe57/sympozium/commit/c7f30483ec41ccb0646fa7aaa151eafac2c9e4d2))
* **web:** complete Agent execution-plane and borrowed-tool creation flow ([#479](https://github.com/pepe57/sympozium/issues/479)) ([842ccec](https://github.com/pepe57/sympozium/commit/842ccec79f84614d37b0184c50eaa6ff54662137))
* **web:** fold model connections into Provider -&gt; Auth -&gt; Model ([718b9d8](https://github.com/pepe57/sympozium/commit/718b9d80d2adbfe5bdfe162304671cd8d48297cf))
* **web:** give Celln the same provider list as the run/agent flow ([e6b80ab](https://github.com/pepe57/sympozium/commit/e6b80ab3e088f0766d8a2240f2ec8d184492a740))
* **web:** make demo topology hardware physically buildable ([eaedf1d](https://github.com/pepe57/sympozium/commit/eaedf1d910f03ead6a7d508799b144c2f9dfb87a))
* **web:** offer persistent Pi and Hermes harnesses ([#480](https://github.com/pepe57/sympozium/issues/480)) ([d0d03d4](https://github.com/pepe57/sympozium/commit/d0d03d4bcf0ca46a969a859bfc2d40255a6f8e9b))
* **web:** prevent gateway toggle from disconnecting UI ([9ededbd](https://github.com/pepe57/sympozium/commit/9ededbd830eb7c409e4340a40b222fd1c7651de4))
* **web:** prevent gateway toggle from disconnecting UI ([3ef4772](https://github.com/pepe57/sympozium/commit/3ef4772500b15a0149be8c1242ff48154ceb8ee0))
* **web:** repair type errors that broke npm run build ([20ce832](https://github.com/pepe57/sympozium/commit/20ce8323dcd9bbb0b2c44d2ce193ef06d25feb04))
* **web:** resolve ReactFlow render loop and Cypress test failures ([#184](https://github.com/pepe57/sympozium/issues/184)) ([ad06e12](https://github.com/pepe57/sympozium/commit/ad06e12ca7217f06aebd92aa1901d0c6058087a4))
* **web:** restore Provider -&gt; Auth -&gt; Model for the Celln wizard flow ([1907b12](https://github.com/pepe57/sympozium/commit/1907b125a30ca1fa43bb73a4dbee46968f6a8c7a))
* **web:** split Create into Harness and Run flows ([0ab8bc1](https://github.com/pepe57/sympozium/commit/0ab8bc1e23eafa3c6a6de9b6e658b38c346e3936))
* **web:** stack and group topology accelerator chips ([77f63b3](https://github.com/pepe57/sympozium/commit/77f63b3cdc9b32d4bee461a048d0f513912f25f5))
