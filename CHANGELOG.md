...
## [0.10.88](https://github.com/pepe57/sympozium/compare/v0.10.87...v0.10.88) (2026-09-26)
...
* **api,web:** tenant path for platform runtimes ([3799827](https://github.com/pepe57/sympozium/commit/3799827f738c18fa532f1f360133c6c121263a49))
* **apiserver:** carry the mediation record into added backends and expose it ([d9b6416](https://github.com/pepe57/sympozium/commit/d9b6416660d42eee1a0b6225a3aa8025218e1118))
* **apiserver:** list key Secrets by name and grant a Celln Agent its connection's Secret ([3299376](https://github.com/pepe57/sympozium/commit/3299376642106e9897e79f2ecd5e834dc41a682e))
...
* **celln:** a conversation outlives its node — continue a lost parent elsewhere with its memory ([7a21e97](https://github.com/pepe57/sympozium/commit/7a21e970fe0aa7f1ae6116725e3a8e64cc0cba56))
* **celln:** a conversation outlives its node — continue a lost parent elsewhere with its memory ([b41f7f0](https://github.com/pepe57/sympozium/commit/b41f7f083268180d01a8b6b305e81c8b33840473))
* **celln:** accept a bare server address and detect its model ([17c358b](https://github.com/pepe57/sympozium/commit/17c358b0c52b40b9fb6e82297e2d4e2ccc158200))
* **celln:** add a model backend from the API and UI ([56b604b](https://github.com/pepe57/sympozium/commit/56b604b7a24c9c5cf8a2455bf1ae6f1f84f67be1))
* **celln:** add a model backend from the API and UI ([ae83b72](https://github.com/pepe57/sympozium/commit/ae83b722639a0e49cce74808cf396d52434fa45c))
* **celln:** add a model backend to a running fleet scope ([0291f2b](https://github.com/pepe57/sympozium/commit/0291f2bf22e6626b151e0ac978abd6621cd11685))
* **celln:** add a model backend to a running fleet scope ([6adf557](https://github.com/pepe57/sympozium/commit/6adf557fc86f6aded0fb90fb809de1544ee9372d))
* **celln:** add durable atomic model-budget ledger ([#503](https://github.com/pepe57/sympozium/issues/503)) ([b6349b5](https://github.com/pepe57/sympozium/commit/b6349b5d5e88d58dbd81230dad1c942567dcc4f9))
...
* **celln:** add read-only migration identity inventory and drain boundaries ([c9a4bf2](https://github.com/pepe57/sympozium/commit/c9a4bf2972543a93db237941f622f62dbec50089))
* **celln:** add shared catalogue and execution-policy API ([#497](https://github.com/pepe57/sympozium/issues/497)) ([d7419d5](https://github.com/pepe57/sympozium/commit/d7419d502b884b1ab1456be2d7b9f25ee1fcce13))
* **celln:** add TLS gateway process and PostgreSQL isolation tests ([9108629](https://github.com/pepe57/sympozium/commit/910862916f70046bc071179a13531ff14c7acef0))
* **celln:** admit an Agent's own Secret-backed connection on the mediated path ([2e99bba](https://github.com/pepe57/sympozium/commit/2e99bbae7c3fa1fad2a6264ef077222ccf56f189))
* **celln:** admit an Agent's own Secret-backed connection on the mediated path ([b1a2973](https://github.com/pepe57/sympozium/commit/b1a2973dd5bea92132ee06b02b3f3637ea88a886))
* **celln:** allow an insecure development registry for the fleet package ([2a8f4ef](https://github.com/pepe57/sympozium/commit/2a8f4efb70f5ca5f9b8e516373b4471fbe6e25a7))
...
* **cellnauthority:** native provisioning material on runtime profiles and host-profile routes ([d795eaf](https://github.com/pepe57/sympozium/commit/d795eaf7c06149bf9c8cca5c1a211212af4cc282))
...
* **celln:** borrowed commands from pinned images as fleet tools ([6e2642f](https://github.com/pepe57/sympozium/commit/6e2642f612f5853b0dcf940c7ec1c1b28ba99b39))
* **celln:** borrowed commands from pinned images as fleet tools ([134bdc4](https://github.com/pepe57/sympozium/commit/134bdc4482e7fb4280346fd79f4bc410554f6e05))
...
* **celln:** cancel fenced model work and verify live gateway readiness ([46388ed](https://github.com/pepe57/sympozium/commit/46388ed9702a71807153531493c269582100a1e9))
* **celln:** choose the fleet's model backend — llama-server, OpenAI, Anthropic or DeepSeek ([8cce038](https://github.com/pepe57/sympozium/commit/8cce038290feb962cdf07fb67bd1c43040f7b652))
...
* **celln:** declare which providers Agents may bring their own key for ([462f838](https://github.com/pepe57/sympozium/commit/462f8387ca4cb71e75defcca80b00675be96539c))
* **celln:** default-open namespace authorisation and on-demand tenant wrappers ([1f6acce](https://github.com/pepe57/sympozium/commit/1f6acce7f69941c1ca3238605492a17b9513c85a))
* **celln:** eight brokered tools — run files listed, appended, searched, deleted; JSON posted ([6331b72](https://github.com/pepe57/sympozium/commit/6331b72553a525526077ae330b5555f603ad6b8a))
* **celln:** eight brokered tools — run files listed, appended, searched, deleted; JSON posted ([326158c](https://github.com/pepe57/sympozium/commit/326158c664a24c5d954ee65d58978baaf1a9c665))
* **celln:** enduring parents from any authorised namespace (P0) ([f5abc12](https://github.com/pepe57/sympozium/commit/f5abc1279a0cb17a5dca202be7aac5d99777d9dc))
* **celln:** enforce original parent lease with terminal expiry visibility ([#464](https://github.com/pepe57/sympozium/issues/464)) ([37e0e47](https://github.com/pepe57/sympozium/commit/37e0e47c61230748060cd30894ebd12f59882b57))
* **celln:** fleet installer stamps the platform catalogue and tenant wrappers ([68ea419](https://github.com/pepe57/sympozium/commit/68ea4191c0d17ecc19079e9b05b6d230c6d870e9))
* **celln:** fleet model backends — llama-server, OpenAI, Anthropic, DeepSeek ([7566d1c](https://github.com/pepe57/sympozium/commit/7566d1c2baf9f348f853fcaad964d734413897aa))
* **celln:** fleet node defaults hold two parents ([46e2014](https://github.com/pepe57/sympozium/commit/46e201451a7c6e42bb4fc974e0569f7fa9fcd360))
* **celln:** fleet nodes size their capacity from node memory ([6a20f1c](https://github.com/pepe57/sympozium/commit/6a20f1c0773538f421099f4b449475d99a635a3c))
* **celln:** freeze controller preparation before native side effects ([f04284c](https://github.com/pepe57/sympozium/commit/f04284c4e994659bd72bd22133333afe3cdb6174))
...
* **celln:** implement scoped capability issuer and verifier ([#499](https://github.com/pepe57/sympozium/issues/499)) ([0981bac](https://github.com/pepe57/sympozium/commit/0981bac047f0a5a7b9e289c044dd2aa2af5360cf))
* **celln:** install mediated model access from the chart behind one switch ([aa471af](https://github.com/pepe57/sympozium/commit/aa471af9c7f3c6e2faff5feeea9d5bfa2743995f))
* **celln:** install mediated model access from the chart behind one switch ([4830920](https://github.com/pepe57/sympozium/commit/483092018db093b42871a8b1759942212fdd5a59)), closes [#611](https://github.com/pepe57/sympozium/issues/611)
* **celln:** let the operator declare mediated routes at install ([c4a3b4b](https://github.com/pepe57/sympozium/commit/c4a3b4b03cc233ddb012b64f7b5c97c28db626a9))
* **celln:** list fleet cells through the gateway, falling back to node reports ([48e35db](https://github.com/pepe57/sympozium/commit/48e35db99dbd53d8aab51515895e079c8a4180c2))
* **celln:** list fleet cells through the gateway, falling back to node reports ([35ef5eb](https://github.com/pepe57/sympozium/commit/35ef5ebb1dded550cc5f1186eeb594c829d90ee9)), closes [#591](https://github.com/pepe57/sympozium/issues/591)
* **celln:** long-running parents — day-long lease ceilings, session defaults, lease deadline in the UI ([d1e900a](https://github.com/pepe57/sympozium/commit/d1e900aaf8101c2433dc001fda3d4bcc909665f2))
* **celln:** long-running parents — day-long leases, session defaults, lease in the UI, capacity-aware placement ([3a70c96](https://github.com/pepe57/sympozium/commit/3a70c963ecee96e406ed28e5234e33960060f1ab))
* **celln:** match Celln v0.5.22's conversation limits, and pin it ([730f4a6](https://github.com/pepe57/sympozium/commit/730f4a6192254b76148ef196c990150ebe0bb7bb))
* **celln:** match the widened enduring-conversation bounds ([a90b876](https://github.com/pepe57/sympozium/commit/a90b87693e1decf0c08eb7600cce1b4828075ea7)), closes [#591](https://github.com/pepe57/sympozium/issues/591)
* **celln:** max output tokens per request for fleet backends ([97d8eca](https://github.com/pepe57/sympozium/commit/97d8ecac4c25bdfb504c2d1cff971e8f8191c635))
* **celln:** mediate explicitly approved keyless local models ([0110107](https://github.com/pepe57/sympozium/commit/01101076bdc560400c13d0bec5dd534a656db69b))
* **celln:** mediate explicitly approved keyless local models ([4576074](https://github.com/pepe57/sympozium/commit/45760747d2d58c543d78b1bd3056f2f36151be0e))
* **celln:** model parameters for fleet backends ([cae4cce](https://github.com/pepe57/sympozium/commit/cae4cce07754aa8aac16601db07a62d1598326ba))
* **celln:** model parameters for fleet backends ([e5f440b](https://github.com/pepe57/sympozium/commit/e5f440b8e6911ddd2e5b5f1114e9bbefe6bdfcb2))
...
* **celln:** one-shot runs on the fleet as single-turn parents ([89611a1](https://github.com/pepe57/sympozium/commit/89611a13eceace226d38dad775f1c840b4713c02))
* **celln:** one-shot runs on the fleet as single-turn parents ([9601fec](https://github.com/pepe57/sympozium/commit/9601feca59a045cea439aa9eafffa53ea05b805d)), closes [#490](https://github.com/pepe57/sympozium/issues/490)
...
* **celln:** output tokens per request for fleet backends ([a6e8880](https://github.com/pepe57/sympozium/commit/a6e8880932150aaa23885a59faaf193a824d6326))
* **cellnparent:** platform-backed parent admission for any authorised namespace ([2e3a021](https://github.com/pepe57/sympozium/commit/2e3a021d60f716943a2cef0ebf9889d5daea88a4))
* **cellnparent:** provision parents through the Celln gateway ([9caf1d2](https://github.com/pepe57/sympozium/commit/9caf1d2c085076ceb555fe5aae32c3bb10eec486))
* **celln:** per-node native fleet — gateway-issued parents, label-to-join nodes ([9eabc23](https://github.com/pepe57/sympozium/commit/9eabc23e3e455b10412102cc7a0d16cc3d423eda))
* **celln:** per-node native fleet installed by labeling KVM nodes ([97168f9](https://github.com/pepe57/sympozium/commit/97168f928d97735a370822e960131e7916d23df1))
* **celln:** pick an Agent's fleet backend and answer once from the UI ([9ca6488](https://github.com/pepe57/sympozium/commit/9ca64880d3a0605fa3d846f45206353a66b37468))
* **celln:** pick an Agent's fleet backend and answer once from the UI ([0676ff5](https://github.com/pepe57/sympozium/commit/0676ff5947462481181c2573b0b5d67f553460da))
* **celln:** policy routes approve plain-HTTP endpoints explicitly for node-held credentials ([cc6f537](https://github.com/pepe57/sympozium/commit/cc6f53792011ae5d87f71ae070197e86799443cd))
...
* **celln:** probe every fleet backend with its key before installing ([d424d67](https://github.com/pepe57/sympozium/commit/d424d67cf6deffc4a94a0a0ce51a735dfab0f9d8))
* **celln:** probe every fleet backend with its key before installing ([48768b0](https://github.com/pepe57/sympozium/commit/48768b0f17f8747adb7465f65943f7a4fcd4f60a))
...
* **celln:** resolve platform policy into immutable decisions ([#498](https://github.com/pepe57/sympozium/issues/498)) ([a3920e0](https://github.com/pepe57/sympozium/commit/a3920e0abf5cb85ed7c864bf29bc0ffb11b62302))
...
* **celln:** several model backends per fleet scope ([949c432](https://github.com/pepe57/sympozium/commit/949c432b60375e715e2ea5bf88ec46387807890e))
* **celln:** several model backends per fleet scope ([3c91183](https://github.com/pepe57/sympozium/commit/3c91183ca0fd60d9a978dacd309945bb856842ef)), closes [#535](https://github.com/pepe57/sympozium/issues/535)
* **celln:** ship real-provider framework workspace with concurrent conversation evidence ([eb0501c](https://github.com/pepe57/sympozium/commit/eb0501ce26008373a75f229fa7215c448cb13714))
...
* **celln:** start many enduring conversations per Agent from the API and UI ([de2874d](https://github.com/pepe57/sympozium/commit/de2874dd21c167ef7a2ce5e8fe15ac435a8e5052))
* **celln:** start many enduring conversations per Agent from the API and UI ([2f749a2](https://github.com/pepe57/sympozium/commit/2f749a2f3a6b1601d6b4c40b3f4bb1eb2f58f3fc))
...
* **celln:** validate release evidence matrix and bounded artifact integrity ([6657cd1](https://github.com/pepe57/sympozium/commit/6657cd196a93ba0d642dfec663ce654895b2d312))
* **celln:** zero-ceremony namespaces, node-sized capacity, terminal refusals (P1a + P1b) ([f98fdf3](https://github.com/pepe57/sympozium/commit/f98fdf337c8f0f49bbd3ab8d3fd6bbbf755a62f3))
* **cli:** add `sympozium update` and `sympozium upgrade` ([664bcfe](https://github.com/pepe57/sympozium/commit/664bcfe6ceda128e194bceb2af2f67f242ee5e4f))
* **cli:** add `sympozium update` and `sympozium upgrade` ([9ecfd9a](https://github.com/pepe57/sympozium/commit/9ecfd9a3302315367afa5fb9b79000090a9a9ec3))
* **cli:** sympozium doctor and an install preflight for used machines ([d379a06](https://github.com/pepe57/sympozium/commit/d379a06b0480b64b1605ea998202acd4f07bac6a))
* **cli:** sympozium doctor and an install preflight for used machines ([d27db72](https://github.com/pepe57/sympozium/commit/d27db72bf3940124b05c2da2d1cbfbb952d3cafe))
...
* **console:** create Celln agents with their own provider, key and model ([9eeaa15](https://github.com/pepe57/sympozium/commit/9eeaa152f69311b0ab9428d212ed58cd97b46abc))
* **console:** give Celln agents their own provider, key and model ([af67a57](https://github.com/pepe57/sympozium/commit/af67a579be2f6522675fcc93d7c4a2eddf547b98))
* **controller:** dispatch scoped one-shot runs through native receiver and gateway ([7cc797f](https://github.com/pepe57/sympozium/commit/7cc797f57d82e533bf40abecb1422f5da37863cc))
* **controller:** reconcile scoped enduring parents and fresh bounded turns ([16b4880](https://github.com/pepe57/sympozium/commit/16b4880f966128fa02a3e1e0cd7135cb80be9ba6))
* **doctor:** report mediated model access ([3043e0d](https://github.com/pepe57/sympozium/commit/3043e0dd777885de76665d9cdd41fb54b26e8513))
...
* **gateway:** per-connection request policy on ModelConnection ([240eab4](https://github.com/pepe57/sympozium/commit/240eab4f8ad9cde403ca23422b3fdf4d8269f16a))
* **gateway:** per-connection request policy on ModelConnection ([d841853](https://github.com/pepe57/sympozium/commit/d84185368f4ee9f3acb8bb53f8743f5d2a2e811a))
* **helm:** package dedicated rootless model gateway with explicit trust dependencies ([cf27393](https://github.com/pepe57/sympozium/commit/cf273937a0ebe18a110d3764998fc54c421e8f1a))
...
* **install:** a bare `sympozium install` enables Celln parents ([647d8af](https://github.com/pepe57/sympozium/commit/647d8af43f95cee4f59e3ee2384f1b083e8f840b))
* **install:** a bare sympozium install enables Celln parents ([a2d6e65](https://github.com/pepe57/sympozium/commit/a2d6e653a002eee812fe6eff74871c041cb5aa52))
...
* **install:** ergoz comes with sympozium install ([25a5d20](https://github.com/pepe57/sympozium/commit/25a5d206a735c7e3b8c5137cd0816c53d3c81675))
* **install:** ergoz comes with sympozium install ([088538c](https://github.com/pepe57/sympozium/commit/088538c32a2b0579c85cf5a170a3c83014bef3d1))
* **install:** every provider key in the environment becomes a backend ([4b4d464](https://github.com/pepe57/sympozium/commit/4b4d4642cfcd5d5ae393be9a1b9ef10899cfc054))
* **install:** every provider key in the environment becomes a backend ([63666c4](https://github.com/pepe57/sympozium/commit/63666c468fdfb287153e6f76df2c1c82f2fde543))
* **install:** generate isolated scoped native manual-review deployment ([cf86695](https://github.com/pepe57/sympozium/commit/cf86695d1465ed2b518ce3c3646f40452955b201))
...
* **review:** add namespace-isolated scoped manager and deterministic TLS provider ([59454ce](https://github.com/pepe57/sympozium/commit/59454cec84bfd18a3185ecc5ec5ff77d4601b133))
* **review:** configure verified provider CA and scoped TLS frontend ([4851fbd](https://github.com/pepe57/sympozium/commit/4851fbda56f91addbdf44178c28984127c2d2e27))
...
* **ui:** expose scoped native runs and enduring turn lifecycle ([4f2d777](https://github.com/pepe57/sympozium/commit/4f2d7779fdd9d7dcb5ba4ee3d91f13ab4b425f0f))
...
* **web:** celln ps per node, cells on the topology and Celln persistent chats ([a20e748](https://github.com/pepe57/sympozium/commit/a20e748649f520094dc13dec4114482151a8b7fb))
* **web:** celln ps per node, cells on the topology and Celln persistent chats ([984101c](https://github.com/pepe57/sympozium/commit/984101c875f9916760cd418c04706240fc990beb))
* **web:** explain why a run failed, and what to do about it ([db2a023](https://github.com/pepe57/sympozium/commit/db2a023577bff9bb174b46f1d1d9a0e7e4f182d1))
* **web:** explain why a run failed, and what to do about it ([e2fa476](https://github.com/pepe57/sympozium/commit/e2fa4768aacee5e2efe98582c44e0a4fadd9b3d9))
* **web:** pick a Celln parent's provider like the Kubernetes plane ([7817747](https://github.com/pepe57/sympozium/commit/78177479abb085064a3a213047911401e7c463d5))
* **web:** say which cluster the console is connected to ([9660d27](https://github.com/pepe57/sympozium/commit/9660d27d65e9af3619f3801fc83a7940bd3dae9d))
* **web:** say which cluster the console is connected to ([4217c10](https://github.com/pepe57/sympozium/commit/4217c108ec6bdf17dde756c9db8e57c073759bcb)), closes [#591](https://github.com/pepe57/sympozium/issues/591)
...
* 415: Gate sequential edges for subagent batch children ([#466](https://github.com/pepe57/sympozium/issues/466)) ([2e8a8b8](https://github.com/pepe57/sympozium/commit/2e8a8b816295b58b4113d761350de03687a2c389))
...
* **api:** preserve explicit Celln preview lifecycle and catalogue scope ([5bd5a3b](https://github.com/pepe57/sympozium/commit/5bd5a3b0764e5e7348f5cd688f871787ec4fa41d))
...
* **authority:** enforce published decision schema before issuance and verification ([41e0cb3](https://github.com/pepe57/sympozium/commit/41e0cb3cedafd054ed71e191b163f57c6c0c1f3c))
* **budget:** atomically bind reservation and recovery to verified ownership ([db6dafa](https://github.com/pepe57/sympozium/commit/db6dafac1c4dd9d1545110061f9b413986bae150))
* **budget:** retain unknown provider usage without fabricating measured zero ([8cf463c](https://github.com/pepe57/sympozium/commit/8cf463c46bb347b015f78a4c0352d309c8f16039))
* **celln:** a create the owner refuses is terminal and deletable ([a06152e](https://github.com/pepe57/sympozium/commit/a06152e32f5004fab701311edd77ca3c31fd0fcc))
* **celln:** a failed first turn no longer ends the conversation ([b1dcbc9](https://github.com/pepe57/sympozium/commit/b1dcbc9614a61569f74c3887560df92f725f9bdc))
* **celln:** a fleet parent holds two egress contexts; default egressSlots to maxCells ([4d9d43c](https://github.com/pepe57/sympozium/commit/4d9d43ca3a99eee2cc7bfbded6ee46324f246006))
...
* **celln:** align parent refusal with published contract ([edc9c73](https://github.com/pepe57/sympozium/commit/edc9c737a1f71a4dfd5c98c86544724c7e2b65a4))
* **cellnauthority:** a spec.model that mirrors the connection route is not an override ([027cfb5](https://github.com/pepe57/sympozium/commit/027cfb596604a2eb40918478b31a00e7d715dc3c))
* **cellnauthority:** compare the pinned connection revision with the value the controller pins ([9b042b8](https://github.com/pepe57/sympozium/commit/9b042b896bbe32e05c29647cf395ddb4e61471f4))
* **celln:** claim provider dispatch after bounded gateway admission ([61434e1](https://github.com/pepe57/sympozium/commit/61434e1a72304b8e0952851a1a4b1ad68a72a009))
* **celln:** correct namespace authorisation contract ([6bd6638](https://github.com/pepe57/sympozium/commit/6bd66383523944cd0065ad8b7d383cc606885e8d))
* **celln:** drop meaningless dispatcher nodeSelector, self-provision state dir ([6efddfb](https://github.com/pepe57/sympozium/commit/6efddfbb224f6ef643f5e6f472a59777531b01f8))
* **celln:** drop meaningless dispatcher nodeSelector, self-provision state dir ([2c76629](https://github.com/pepe57/sympozium/commit/2c7662906477e35c02ae9751626e834a86cd4120))
* **celln:** fence and atomically claim model provider dispatch ([be60e8e](https://github.com/pepe57/sympozium/commit/be60e8e6c2d1d7fb4f04a2e273e9808e292bd702))
* **celln:** guard optional cluster tool validation ([6083c23](https://github.com/pepe57/sympozium/commit/6083c23b57465522f85fff7a4b373557c327a731))
...
* **celln:** keep a conversation open after a failed initial turn ([096bbfc](https://github.com/pepe57/sympozium/commit/096bbfcc936f323331833d2f8ab064b06dd83b5b))
* **celln:** let a fleet backend's turn lifetime follow its output-token cap ([8000d51](https://github.com/pepe57/sympozium/commit/8000d5166723ee9e318847abe2e5bece828c954a))
* **celln:** let a fleet backend's turn lifetime follow its output-token cap ([f020d3e](https://github.com/pepe57/sympozium/commit/f020d3eb902ef5d9b15090017f379de0251cd2e7))
* **celln:** make accepted tool-free fixtures conform to schema ([8b69b03](https://github.com/pepe57/sympozium/commit/8b69b039c682697bbe5d5160d1896969296af376))
* **celln:** move an installed fleet to a new starter package ([07ba1b0](https://github.com/pepe57/sympozium/commit/07ba1b04433840f65d56be2d79d1a65a1542a861))
* **celln:** move an installed fleet to a new starter package ([1e1520a](https://github.com/pepe57/sympozium/commit/1e1520acdb4d4fd6fdf33f0ac7f560d64e6b6d80))
* **cellnparent:** admit native parents with the profile's per-turn allowance and retry from the pinned choice ([929ce6b](https://github.com/pepe57/sympozium/commit/929ce6b08b7f5d7dd5029ced4b994a715ac1da43))
* **cellnparent:** treat an owner that left the plane as context loss ([298682c](https://github.com/pepe57/sympozium/commit/298682cdc499e763a8e2269022b0133e16cfcb57))
* **celln:** pin Celln v0.5.25 ([2f3698e](https://github.com/pepe57/sympozium/commit/2f3698e02c0d8ccab004ab7d9d1bfd4cfece1fbe))
* **celln:** pin Celln v0.5.25 (worker turn lifetime follows the output-token cap) ([676da52](https://github.com/pepe57/sympozium/commit/676da52bdbf5ded0cb0d2da448f20b2d10bab584))
* **celln:** pin Celln v0.5.26 ([09dc2ea](https://github.com/pepe57/sympozium/commit/09dc2eaf601fbd7dd7d8b76fd9e68e7a16161bec))
* **celln:** pin Celln v0.5.26 (mediated native parents: scoped receiver, per-operation output cap, starter parent request) ([619e980](https://github.com/pepe57/sympozium/commit/619e980e42316b7adeaa604df70b0f937cf7a39e))
* **celln:** pin v0.5.27 for installed mediated runs ([e0e593f](https://github.com/pepe57/sympozium/commit/e0e593f000f827d300af19be6f79e145987ccdd8))
* **celln:** pin v0.5.27 for installed mediated runs ([5404447](https://github.com/pepe57/sympozium/commit/5404447de6037e5c66108daeddf9088b983cf484))
* **celln:** pin v0.5.28 for isolated starter runtimes ([4985084](https://github.com/pepe57/sympozium/commit/4985084513216ba1e26ed4a723ad4ea230f749cf))
* **celln:** pin v0.5.28 for isolated starter runtimes ([0dc600f](https://github.com/pepe57/sympozium/commit/0dc600f0a438edf9d26487e698b3290003be0d63))
* **celln:** prefer work-deadline expiry for model verification ([dcb5037](https://github.com/pepe57/sympozium/commit/dcb503767e70586df185bb643ff66b58bf5b4e43))
* **celln:** prevent shared-tool intent entering legacy parent issuance ([97f3243](https://github.com/pepe57/sympozium/commit/97f32431ea03590e0f98c60cca59efeb97b97154))
* **celln:** propagate dispatcher pod tolerations ([#632](https://github.com/pepe57/sympozium/issues/632)) ([1dff955](https://github.com/pepe57/sympozium/commit/1dff955421e2c20ba6d39e022803c7a51723d399))
* **celln:** publish fleet trust after the chart creates celln-system ([9854fa9](https://github.com/pepe57/sympozium/commit/9854fa9fd4c523b44258e26404b6a1957b6850c4))
* **celln:** refuse shared-tool intent in legacy one-shot issuance ([943e524](https://github.com/pepe57/sympozium/commit/943e5249721659b513d4b230af6c0ed2f8912b5c))
...
* **celln:** serialize ledger reconciliation across replicas ([bf28a11](https://github.com/pepe57/sympozium/commit/bf28a11d6ffa3800a572d0a05e842d8219239af1))
* **celln:** stop continuing a continuation that is lost again at once ([1894d78](https://github.com/pepe57/sympozium/commit/1894d78017ef7b1339109ef2dbb6af6531a936f5))
* **celln:** stop continuing a continuation that is lost again at once ([5565633](https://github.com/pepe57/sympozium/commit/55656335e58be44b98c08de0e72ea180c8372091))
* **celln:** use published protocol refusal reason ([24be045](https://github.com/pepe57/sympozium/commit/24be045f005f472bcdc148d9d1c806c7dbc1b124))
...
* **celln:** wait for the controller rollout before binding the fleet catalogue ([4504be0](https://github.com/pepe57/sympozium/commit/4504be0d90ea8adf575f4dee79bd0e76ecfd05df))
...
* **channel:** reply on agent failure and stop cross-instance outbound… ([#581](https://github.com/pepe57/sympozium/issues/581)) ([82117f1](https://github.com/pepe57/sympozium/commit/82117f14126cf3b4b856520455096ae6380292bb))
* **chart:** NATS passwords never start with a digit ([562fe73](https://github.com/pepe57/sympozium/commit/562fe731b191c5fad9e18c2860d4593496df1924))
* **ci:** publish dedicated gateway and repair inherited workflow YAML ([3bd649e](https://github.com/pepe57/sympozium/commit/3bd649e850530a425477664fff935e9fd452dfa3))
* **ci:** verify the reviewed contract without rewriting or pushing PR source ([3777b31](https://github.com/pepe57/sympozium/commit/3777b31f2ec82a1e31c28ddcc0978c51579d94a7))
* **controller:** fence cancelled turns and stop completed cleanup loops ([3c78f6c](https://github.com/pepe57/sympozium/commit/3c78f6c899a65446c4cafb2ff07e4cabe9b795d0))
...
* **controller:** revalidate frozen policy before first scoped dispatch ([29447e7](https://github.com/pepe57/sympozium/commit/29447e785b929f89f9ab0deb3753fe3b26b95f86))
* **controller:** route legacy enduring selections to the prepared parent path ([a69f82c](https://github.com/pepe57/sympozium/commit/a69f82ceeadd8d2343e0b92adccb94e05eb6d960))
* **controller:** serve AgentRunTurn on the unified native parent path ([127dab7](https://github.com/pepe57/sympozium/commit/127dab77b71d7c707526890e83dabb69c505cba8))
* **deps:** mark go-jose as direct dependency ([12f4cbd](https://github.com/pepe57/sympozium/commit/12f4cbdf85c5bb7cbc02ee599b78d6eed81d579c))
* **enduring:** reserve retained substrate capacity and preserve uncertain owner state ([ce67ad1](https://github.com/pepe57/sympozium/commit/ce67ad153f503aec045004f10d112163a0fe61f8))
* **eventbus:** survive NATS being unavailable at startup and consumer reaping ([7b0406b](https://github.com/pepe57/sympozium/commit/7b0406b04a579379476b65d4ea5b45dbe2033594))
* **eventbus:** survive NATS being unavailable at startup and consumer reaping ([c7cbcf3](https://github.com/pepe57/sympozium/commit/c7cbcf3eff196f4c6d3fa8a6f6a6fa01ea9d4d68))
* **gateway:** align request canonicalization and decision fixtures with Rust receiver ([8d01032](https://github.com/pepe57/sympozium/commit/8d010323f0596b8d84c303308145f93317eb7a91))
* **gateway:** bind durable admission, preserve unknown usage and scope turn cleanup ([04ef174](https://github.com/pepe57/sympozium/commit/04ef1748f9f8f367c077821c67ed53880e84ac81))
...
* **install:** Helm follows $KUBECONFIG like kubectl; drop symptom workarounds ([aedfb12](https://github.com/pepe57/sympozium/commit/aedfb126ec0ff8110064b75e856cdbd78d84b9a7))
* **install:** qualify framework KVM packaging, persistent ledger and bounded manual workflows ([5e61e22](https://github.com/pepe57/sympozium/commit/5e61e224174bd7c5a7d00608ed330035750846e3))
* **install:** refresh Helm discovery after CRDs and always wait for cert-manager's webhook ([3142b5d](https://github.com/pepe57/sympozium/commit/3142b5d517346691643d5cd3670178ff4aa787e8))
* **install:** retry the cert-manager manifest download ([cfa6a06](https://github.com/pepe57/sympozium/commit/cfa6a06bae54fef9f173e3749d88621e81350331))
* **install:** retry the Helm release when an admission webhook is briefly unreachable ([510e49a](https://github.com/pepe57/sympozium/commit/510e49a2ea8d0dab1046826e70af14c22ef14145))
* **install:** say why a fleet wait is empty, and that Kind needs a kernel ([944668e](https://github.com/pepe57/sympozium/commit/944668ef2fae8166489765566e78aa0be34d225b))
* **install:** say why a fleet wait is empty, and that Kind needs a kernel ([cb70dee](https://github.com/pepe57/sympozium/commit/cb70dee260b25462a4d2800b53d91f7539d7e3a5))
* **install:** the Kind kernel copy is a Linux-host mitigation; KVM is already there ([1fb7d6c](https://github.com/pepe57/sympozium/commit/1fb7d6c193a24665f39bf7c62b0c6fb8422bec70))
* **install:** wait for CRDs to be established and retry the Gateway API download ([96678a3](https://github.com/pepe57/sympozium/commit/96678a3741aea728139c037aae821a4696520d58))
* **integration:** preserve recovery authority and enforce the contract issuer ([44cc86d](https://github.com/pepe57/sympozium/commit/44cc86de8a39e4104118679ad175c882965ddb03))
* **integration:** retain protected record identities before run deletion ([5d3eeb9](https://github.com/pepe57/sympozium/commit/5d3eeb92b243329c946cf3bf54d07e612183d4f0))
* **release:** build the starter package from relative paths ([f88bbb1](https://github.com/pepe57/sympozium/commit/f88bbb17b355ddbbd72628ffc249ced5ce1a11d3))
* **release:** build the starter package from relative paths ([5cdccd0](https://github.com/pepe57/sympozium/commit/5cdccd02c1e7c531efffb712b8c75964f835bf62))
* **release:** find mke2fs and debugfs on Debian runners ([63ae579](https://github.com/pepe57/sympozium/commit/63ae5797f54dce927877464d218f90ed45e14def))
* **release:** find mke2fs and debugfs on Debian runners ([26e64f9](https://github.com/pepe57/sympozium/commit/26e64f96666be5ba5a2977060ef0251d35328ddf))
* **release:** republish the Celln starter package when its inputs are unchanged ([9714173](https://github.com/pepe57/sympozium/commit/9714173529693e7346f1e022bdcd3df78c4b621f))
* **release:** republish the Celln starter package when its inputs are unchanged ([326490d](https://github.com/pepe57/sympozium/commit/326490dd70bf0e55418cddbab1174caec9b5cc2d)), closes [#591](https://github.com/pepe57/sympozium/issues/591)
* **scoped:** fence exhausted turn registration and complete retained-root cleanup ([98e8107](https://github.com/pepe57/sympozium/commit/98e8107e39a1cdbe8fd2ee279c7e432e3dbf7034))
* **ui:** say what enables the Celln parent plane ([55c7d03](https://github.com/pepe57/sympozium/commit/55c7d03262f56cce50e61ad1501d9028e31c99fd))
* **ui:** say what enables the Celln parent plane ([c193c6b](https://github.com/pepe57/sympozium/commit/c193c6b6c41e9941d60ec65f49906bb10f63aa38))
* **web:** Celln tool grid, provider picker and llama-server auto-detect ([fee3d49](https://github.com/pepe57/sympozium/commit/fee3d49678403bc9dd7de10468fdafb60ae45021))
* **web:** choose a fleet backend once, and keep the wizard inside its dialog ([fe215a7](https://github.com/pepe57/sympozium/commit/fe215a72eceadc4a04f6849ce44cb5c31bce34d9))
* **web:** choose a fleet backend once, and keep the wizard inside its dialog ([aa550a4](https://github.com/pepe57/sympozium/commit/aa550a4532b543ea6598c4aedabee60e5c40e39a))
...
* **web:** make the Create Agent wizard fleet-aware ([91f659d](https://github.com/pepe57/sympozium/commit/91f659d4a67a051b6c6de41ce432c4a920985fb2))
* **web:** make the Create Agent wizard fleet-aware ([470e16d](https://github.com/pepe57/sympozium/commit/470e16d68d75173cae564e40a9d37c8f590f6973)), closes [#591](https://github.com/pepe57/sympozium/issues/591)
...
* **web:** scrollable tool grid and select all compatible Celln tools by default ([8883051](https://github.com/pepe57/sympozium/commit/888305170b49be586ff455874613cb6c2ae54d1d))
